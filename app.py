...
def find_range(angles_avg):
    return (max(angles_avg)-min(angles_avg))
...
dropdown1 = dcc.Dropdown(
        ...
        options=[
            ...
            {'label': 'High Knee', 'value': 'highknee'},
...
app.layout = html.Div([dcc.Location(id="url"), jumbotron, html.Div([row, cardfig1,cardfig2],className="mx-5")])

"""@app.callback(
    [Output("modal", "is_open")],
    [Input("demo-dropdown1", "value"), Input("close", "n_clicks")],
    [State("modal", "is_open")],
)
def toggle_modal(value, n2, is_open):
    if n2:
        return [not is_open]
    return [is_open]"""
